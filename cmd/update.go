...
// update self-updates the instantly binary by cloning the latest source from GitHub,
...
const repoURL = "https://github.com/the20100/instantly-cli"

var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update instantly to the latest version from GitHub",
...
func runUpdate(cmd *cobra.Command, args []string) error {
	...
	tmpDir, err := os.MkdirTemp("", "instantly-update-*")
	if err != nil {
	...
	newBin := filepath.Join(tmpDir, "instantly")
